...
url = 'http://10.0.0.171/cam-hi.jpg' #Alterar
    ...
    if len(classIds) != 0:
        for classId, confidence,box in zip(classIds.flatten(),confs.flatten(),bbox):
            ...
            if classNames[classId-1] =='persona':
                ...
                count = count + 1
                    #flag = False
                texto = classNames[classId-1] + ": " + str(count)
                cv2.putText(img, texto, (box[0]+10,box[1]+30), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0),2)
                #print(count)
            ...
            #enviar par asd card, nuvem, webpage
